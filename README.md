...
#### Additional instructions around power management and charging/using the battery can be found in the Battery Manual contained [here](LiPO-Battery-Installation-Maintenance-User-Manual.pdf) 
